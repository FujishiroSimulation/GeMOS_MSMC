...
// #####################
 if(NOVALLEY[Material]==3){
    ...
    GM[Material]=SWK[Material][1][12][1];
    for(ie=1;ie<=DIME;ie++){
        if(SWK[Material][1][12][ie]>GM[Material]) {
            GM[Material]=SWK[Material][1][12][ie];
        }
    }   
    printf("L[%d] = %g \n",Material, GM[Material]);
    for(i=1;i<=12;i++){
    ...
    GM[Material]=SWK[Material][2][6][1];
    for(ie=1;ie<=DIME;ie++){
        if(SWK[Material][2][6][ie]>GM[Material]){
            GM[Material]=SWK[Material][2][6][ie];
        }
    }
    printf("GAMMA[%d] = %g \n",Material, GM[Material]);
    for(i=1;i<=6;i++){
    ...
    GM[Material]=SWK[Material][3][10][1];
    for(ie=1;ie<=DIME;ie++){
        if(SWK[Material][3][10][ie]>GM[Material]){
            GM[Material]=SWK[Material][3][10][ie];
        }
    }
    printf("DELTA[%d] = %g \n",Material, GM[Material]);
    for(i=1;i<=10;i++){
        for(ie=1;ie<=DIME;ie++){
            SWK[Material][3][i][ie]/=GM[Material];
