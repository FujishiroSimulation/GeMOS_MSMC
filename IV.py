...
for gate in gate_voltage:
    for drain in drain_voltages:
        ...
        DONORDENSITY    0.       0.         0.2e-6    16.0e-9   1.e21\n\
        DONORDENSITY    0.       12.0e-9    0.034e-6    16.0e-9   5.e21\n\
        DONORDENSITY    0.166e-6   12.0e-9    0.2e-6    16.0e-9   5.e21\n\
        ACCEPTORDENSITY 0.       0.         0.2e-6    16.0e-9   1.e21\n\
