...
for voltage in applied_voltages:
    ...
    DONORDENSITY    0.       0.         0.2e-6    16.0e-9   1.e22\n\
    DONORDENSITY    0.       12.0e-9    0.034e-6    16.0e-9   5.e22\n\
    DONORDENSITY    0.166e-6   12.0e-9    0.2e-6    16.0e-9   5.e22\n\
    ACCEPTORDENSITY 0.       0.         0.2e-6    16.0e-9   1.e19\n\
